...
screens = {
    ...
    3: function(){lcd.clear();nu = new Date();lcd.println("TEST 2 " + ('0'+ (nu.getHours() + 4)).slice(-2) + ":" + ('0'+ nu.getMinutes()).slice(-2),1); lcd.println("datum: " + nu.getDate() + "/" + ('0'+ (nu.getMonth() + 1)).slice(-2),2)},
